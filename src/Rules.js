...
const threeOfKind = new SumDistro({ count: 3, description: "If 3 are the same, sum all dice." });
const fourOfKind = new SumDistro({ count: 4, description: "If 4 are the same, sum all dice." });
